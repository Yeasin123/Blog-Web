                ...
                <div class="col-md-8">
                    ...
                    <!-- Single Item Blog Post Start -->
                        ...
                        <?php
                            ...
                            $postread = mysqli_query($db,$sql);
                            $totalpost = mysqli_num_rows($postread);

                            if($totalpost == 0){ ?>

                                    <div class="alert alert-warning"><strong>Opp.. There Are no Post</strong></div>
                          <?php  }
